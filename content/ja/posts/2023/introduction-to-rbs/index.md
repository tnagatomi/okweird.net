...
![Date.current補完ビフォー](date_current_before.png)

できるようになった！  
![Date.current補完アフター](date_current_after.png)

さらにクラスにカーソルを当てるとこういうドキュメントも出るようになった！  
![Dateクラスのドキュメントのポップアップ](date_class_document.png)
